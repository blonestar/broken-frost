...
<h2 class="wp-block-heading has-text-align-center has-max-60-font-size" id="block-patterns" style="margin-bottom:0px"><?php echo esc_html__( 'Our Pricing', 'nofrost' ); ?></h2>
<!-- /wp:heading -->
<!-- wp:paragraph {"align":"center","style":{"spacing":{"margin":{"bottom":"var:preset|spacing|medium"}}}} -->
<p class="has-text-align-center" style="margin-bottom:var(--wp--preset--spacing--medium)"><?php echo esc_html__( 'No Frost is the ultimate WordPress theme for website builders.', 'nofrost' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<p class="has-text-align-center has-small-font-size" style="line-height:1.5"><?php echo esc_html__( 'Personal', 'nofrost' ); ?></p>
<!-- /wp:paragraph -->
...
<p class="has-text-align-center has-small-font-size"><?php echo esc_html__( 'Feature Item', 'nofrost' ); ?></p>
<!-- /wp:paragraph -->
...
<div class="wp-block-button has-custom-width wp-block-button__width-100"><a class="wp-block-button__link wp-element-button"><?php echo esc_html__( 'Get Started', 'nofrost' ); ?></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:column -->
...
<div class="wp-block-column has-base-color has-contrast-background-color has-text-color has-background" style="padding-top:var(--wp--preset--spacing--small);padding-right:var(--wp--preset--spacing--small);padding-bottom:var(--wp--preset--spacing--small);padding-left:var(--wp--preset--spacing--small)"><!-- wp:group {"style":{"spacing":{"blockGap":"0"}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group"><!-- wp:paragraph {"align":"center","style":{"typography":{"lineHeight":"1.5"}},"fontSize":"small"} -->
<p class="has-text-align-center has-small-font-size" style="line-height:1.5"><?php echo esc_html__( 'Professional', 'nofrost' ); ?></p>
<!-- /wp:paragraph -->
<!-- wp:paragraph {"align":"center","style":{"typography":{"fontStyle":"normal","fontWeight":"500"}},"fontSize":"max-36"} -->
...
<div class="wp-block-column has-base-color has-contrast-background-color has-text-color has-background" style="padding-top:var(--wp--preset--spacing--small);padding-right:var(--wp--preset--spacing--small);padding-bottom:var(--wp--preset--spacing--small);padding-left:var(--wp--preset--spacing--small)"><!-- wp:group {"style":{"spacing":{"blockGap":"0"}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group"><!-- wp:paragraph {"align":"center","style":{"typography":{"lineHeight":"1.5"}},"fontSize":"small"} -->
<p class="has-text-align-center has-small-font-size" style="line-height:1.5"><?php echo esc_html__( 'Enterprise', 'nofrost' ); ?></p>
<!-- /wp:paragraph -->
<!-- wp:paragraph {"align":"center","style":{"typography":{"fontStyle":"normal","fontWeight":"500"}},"fontSize":"max-36"} -->
...
<!-- /wp:heading -->
<!-- wp:paragraph {"align":"center","style":{"spacing":{"margin":{"bottom":"var:preset|spacing|medium"}}}} -->
<p class="has-text-align-center" style="margin-bottom:var(--wp--preset--spacing--medium)"><?php echo esc_html__( 'Below is a list of frequently asked questions.', 'nofrost' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
<!-- wp:group {"style":{"spacing":{"blockGap":"10px"}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group"><!-- wp:paragraph {"align":"center"} -->
<p class="has-text-align-center"><strong><?php echo esc_html__( 'Why should I download the No Frost WordPress theme?', 'nofrost' ); ?></strong></p>
<!-- /wp:paragraph -->
<!-- wp:paragraph {"align":"center"} -->
<p class="has-text-align-center"><?php echo esc_html__( 'With its clean, minimal design and powerful feature set, No Frost enables agencies to build stylish and sophisticated WordPress websites.', 'nofrost' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
