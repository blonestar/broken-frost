 ...
 * Slug: nofrost/general-testimonials-image-contrast-background
...
<p style="margin-top:0"><?php echo esc_html__( 'With its clean, minimal design and powerful features, No Frost enables agencies to build cool websites.', 'nofrost' ); ?></p>
<!-- /wp:paragraph -->
