 ...
 * Slug: nofrost/general-boxes-two-contrast-background
 * Categories: text
 */
?>
...
<h3 class="wp-block-heading has-x-large-font-size" id="sample-heading-1"><?php echo esc_html__( 'Build with No Frost', 'nofrost' ); ?></h3>
<!-- /wp:heading -->
<!-- wp:paragraph -->
...
<div class="wp-block-button"><a class="wp-block-button__link wp-element-button"><?php echo esc_html__( 'Learn More', 'nofrost' ); ?></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:column -->
