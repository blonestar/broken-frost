 ...
 * Slug: nofrost/general-testimonials-contrast-background
...
<p class="has-text-align-center" style="margin-top:0px"><?php echo esc_html__( 'With its clean, minimal design and powerful features, No Frost enables agencies to build cool websites.', 'nofrost' ); ?></p>
<!-- /wp:paragraph -->
