...
<h2 class="wp-block-heading has-max-60-font-size" id="we-reimagine-how-to-build-wordpress-websites" style="margin-bottom:0px;letter-spacing:-1px"><?php echo esc_html__( 'Experience the next generation of WordPress.', 'nofrost' ); ?></h2>
<!-- /wp:heading -->
<!-- wp:paragraph {"style":{"spacing":{"margin":{"top":"var:preset|spacing|x-small"}}},"fontSize":"large"} -->
<p class="has-large-font-size" style="margin-top:var(--wp--preset--spacing--x-small)"><?php echo esc_html__( 'Whether you’re building a website for your business, personal brand, or creative project, No Frost is the perfect solution for anyone looking to launch a website quickly and efficiently.', 'nofrost' ); ?></p>
<!-- /wp:paragraph -->
...
<div class="wp-block-button has-custom-font-size has-small-font-size"><a class="wp-block-button__link wp-element-button"><?php echo esc_html__( 'Get Started', 'nofrost' ); ?></a></div>
<!-- /wp:button -->
...
<div class="wp-block-button has-custom-font-size is-style-outline-background is-style-outline has-small-font-size"><a class="wp-block-button__link wp-element-button" style="padding-top:14px;padding-right:29px;padding-bottom:14px;padding-left:29px"><?php echo esc_html__( 'Learn More', 'nofrost' ); ?></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:column -->
...
<h2 class="wp-block-heading has-text-align-center has-max-60-font-size" id="text-on-left-image-on-right" style="letter-spacing:-1px">Build with No Frost.</h2>
<!-- /wp:heading -->
<!-- wp:paragraph {"align":"center","style":{"typography":{"lineHeight":"1.5"}}} -->
<p class="has-text-align-center" style="line-height:1.5"><?php echo esc_html__( 'With its clean, minimal design and powerful feature set, No Frost enables agencies to build stylish and sophisticated WordPress websites.', 'nofrost' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<h3 class="wp-block-heading has-small-font-size" style="text-transform:uppercase"><?php echo esc_html__( 'Design', 'nofrost' ); ?></h3>
<!-- /wp:heading -->
<!-- wp:paragraph {"style":{"typography":{"lineHeight":"1.5"}},"fontSize":"small"} -->
<p class="has-small-font-size" style="line-height:1.5"><?php echo esc_html__( 'The foundation on which aesthetics, user experience, and functionality is built.', 'nofrost' ); ?></p>
<!-- /wp:paragraph -->
<!-- wp:paragraph {"fontSize":"small"} -->
<p class="has-small-font-size"><a href="#features"><?php echo esc_html__( 'Learn More →', 'nofrost' ); ?></a></p>
<!-- /wp:paragraph --></div>
<!-- /wp:column -->
...
<!-- /wp:paragraph -->
<!-- wp:heading {"level":3,"style":{"typography":{"textTransform":"uppercase"}},"className":"wp-block-heading","fontSize":"small"} -->
<h3 class="wp-block-heading has-small-font-size" style="text-transform:uppercase"><?php echo esc_html__( 'Patterns', 'nofrost' ); ?></h3>
<!-- /wp:heading -->
<!-- wp:paragraph {"style":{"typography":{"lineHeight":"1.5"}},"fontSize":"small"} -->
<p class="has-small-font-size" style="line-height:1.5"><?php echo esc_html__( 'A preset bundle of blocks that empower builders and amplify their creativity.', 'nofrost' ); ?></p>
<!-- /wp:paragraph -->
<!-- wp:paragraph {"style":{"elements":{"link":{"color":{"text":"var:preset|color|base"}}}},"fontSize":"small"} -->
<p class="has-link-color has-small-font-size"><a href="#"><?php echo esc_html__( 'Learn More →', 'nofrost' ); ?></a></p>
<!-- /wp:paragraph --></div>
<!-- /wp:column -->
...
<!-- /wp:paragraph -->
<!-- wp:heading {"level":3,"style":{"typography":{"textTransform":"uppercase"}},"className":"wp-block-heading","fontSize":"small"} -->
<h3 class="wp-block-heading has-small-font-size" style="text-transform:uppercase"><?php echo esc_html__( 'Layouts', 'nofrost' ); ?></h3>
<!-- /wp:heading -->
<!-- wp:paragraph {"style":{"typography":{"lineHeight":"1.5"}},"fontSize":"small"} -->
<p class="has-small-font-size" style="line-height:1.5"><?php echo esc_html__( 'A collection of full-page patterns used to showcase content or a message.', 'nofrost' ); ?></p>
<!-- /wp:paragraph -->
<!-- wp:paragraph {"style":{"elements":{"link":{"color":{"text":"var:preset|color|base"}}}},"fontSize":"small"} -->
<p class="has-link-color has-small-font-size"><a href="#"><?php echo esc_html__( 'Learn More →', 'nofrost' ); ?></a></p>
<!-- /wp:paragraph --></div>
...
<!-- /wp:paragraph -->
<!-- wp:heading {"level":3,"style":{"typography":{"textTransform":"uppercase"}},"className":"wp-block-heading","fontSize":"small"} -->
<h3 class="wp-block-heading has-small-font-size" style="text-transform:uppercase"><?php echo esc_html__( 'Styles', 'nofrost' ); ?></h3>
<!-- /wp:heading -->
<!-- wp:paragraph {"style":{"typography":{"lineHeight":"1.5"}},"fontSize":"small"} -->
<p class="has-small-font-size" style="line-height:1.5"><?php echo esc_html__( 'An essential element of web design used to create a visually striking design.', 'nofrost' ); ?></p>
<!-- /wp:paragraph -->
<!-- wp:paragraph {"style":{"elements":{"link":{"color":{"text":"var:preset|color|base"}}}},"fontSize":"small"} -->
<p class="has-link-color has-small-font-size"><a href="#"><?php echo esc_html__( 'Learn More →', 'nofrost' ); ?></a></p>
<!-- /wp:paragraph --></div>
...
<p class="has-large-font-size" style="line-height:1.5"><?php echo esc_html__( 'With its clean, minimal design and powerful feature set, No Frost enables agencies to build stylish and sophisticated WordPress websites. Ka-chow!', 'nofrost' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:column -->
...
<div class="wp-block-button is-style-fill"><a class="wp-block-button__link has-primary-background-color has-background wp-element-button"><?php echo esc_html__( 'View Patterns', 'nofrost' ); ?></a></div>
<!-- /wp:button -->
<!-- wp:button {"textColor":"base","className":"is-style-outline"} -->
<div class="wp-block-button is-style-outline"><a class="wp-block-button__link has-base-color has-text-color wp-element-button"><?php echo esc_html__( 'View Layouts', 'nofrost' ); ?></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
...
<h2 class="wp-block-heading has-text-align-center has-max-48-font-size" id="block-patterns" style="margin-bottom:0px"><?php echo esc_html__( 'Meet the team.', 'nofrost' ); ?></h2>
<!-- /wp:heading -->
<!-- wp:paragraph {"align":"center","style":{"spacing":{"margin":{"bottom":"var:preset|spacing|medium"}}}} -->
<p class="has-text-align-center" style="margin-bottom:var(--wp--preset--spacing--medium)"><?php echo esc_html__( 'The talented folks who work on the No Frost theme.', 'nofrost' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<h3 class="wp-block-heading has-text-align-center has-medium-font-size" id="member-name-1"><?php echo esc_html__( 'Member Name', 'nofrost' ); ?></h3>
<!-- /wp:heading -->
<!-- wp:paragraph {"align":"center","style":{"typography":{"lineHeight":"1.5"}}} -->
<p class="has-text-align-center" style="line-height:1.5"><?php echo esc_html__( 'I’m a WordPress developer and enjoy building websites.', 'nofrost' ); ?></p>
<!-- /wp:paragraph -->
